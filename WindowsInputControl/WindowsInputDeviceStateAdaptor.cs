...
namespace WindowsInputControl
{
    ...
    public class WindowsInputDeviceStateAdaptor : IInputDeviceStateAdaptor
    {
        ...
        {
            short result = NativeKeyboardMethods.GetKeyState((ushort) virtualKey);
            return (result < 0);
        }
        ...
        ///     SetKeyboardState, GetAsyncKeyState, GetKeyState, and MapVirtualKey functions.
        /// </remarks>
        public bool IsKeyUp(VirtualKey virtualKey)
        {
        ...
        {
            var result = NativeKeyboardMethods.GetAsyncKeyState((ushort) virtualKey);
            return (result < 0);
        }
        ...
        ///     SetKeyboardState, GetAsyncKeyState, GetKeyState, and MapVirtualKey functions.
        /// </remarks>
        public bool IsHardwareKeyUp(VirtualKey virtualKey)
        {
            return !IsHardwareKeyDown(virtualKey);
        }
