...
namespace WindowsInputControl
{
    ...
    public interface IMouseInputControl
    {
        ...
        IMouseInputControl MoveMouseBy(int pixelDeltaX, int pixelDeltaY);
        ...
        /// </param>
        IMouseInputControl MoveMouseTo(double absoluteX, double absoluteY);
        ...
        /// </param>
        IMouseInputControl MoveMouseToPositionOnVirtualDesktop(double absoluteX, double absoluteY);

        /// <summary>
        ///     Simulates a mouse left button down gesture.
        /// </summary>
        IMouseInputControl LeftButtonDown();

        /// <summary>
        ///     Simulates a mouse left button up gesture.
        /// </summary>
        IMouseInputControl LeftButtonUp();

        /// <summary>
        ///     Simulates a mouse left button click gesture.
        /// </summary>
        IMouseInputControl LeftButtonClick();

        /// <summary>
        ///     Simulates a mouse left button double-click gesture.
        /// </summary>
        IMouseInputControl LeftButtonDoubleClick();

        /// <summary>
        ///     Simulates a mouse right button down gesture.
        /// </summary>
        IMouseInputControl RightButtonDown();

        /// <summary>
        ///     Simulates a mouse right button up gesture.
        /// </summary>
        IMouseInputControl RightButtonUp();

        /// <summary>
        ///     Simulates a mouse right button click gesture.
        /// </summary>
        IMouseInputControl RightButtonClick();

        /// <summary>
        ///     Simulates a mouse right button double-click gesture.
        /// </summary>
        IMouseInputControl RightButtonDoubleClick();

        /// <summary>
        ///     Simulates a mouse X button down gesture.
        /// </summary>
        /// <param name="buttonId">The button id.</param>
        IMouseInputControl XButtonDown(int buttonId);

        /// <summary>
        ///     Simulates a mouse X button up gesture.
        /// </summary>
        /// <param name="buttonId">The button id.</param>
        IMouseInputControl XButtonUp(int buttonId);

        /// <summary>
        ///     Simulates a mouse X button click gesture.
        /// </summary>
        /// <param name="buttonId">The button id.</param>
        IMouseInputControl XButtonClick(int buttonId);

        /// <summary>
        ///     Simulates a mouse X button double-click gesture.
        /// </summary>
        /// <param name="buttonId">The button id.</param>
        IMouseInputControl XButtonDoubleClick(int buttonId);
        ...
        ///     user.
        /// </param>
        IMouseInputControl VerticalScroll(int scrollAmountInClicks);
        ...
        /// </param>
        IMouseInputControl HorizontalScroll(int scrollAmountInClicks);

        /// <summary>
        ///     Sleeps the executing thread to create a pause between simulated inputs.
        /// </summary>
        /// <param name="millisecondsTimeout">The number of milliseconds to wait.</param>
        IMouseInputControl Sleep(int millisecondsTimeout);

        /// <summary>
        ///     Sleeps the executing thread to create a pause between simulated inputs.
        /// </summary>
        /// <param name="timeout">The time to wait.</param>
        IMouseInputControl Sleep(TimeSpan timeout);
    }
}