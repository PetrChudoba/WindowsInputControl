...
namespace WindowsInputControl
{
    ...
    ///     <see cref="System.Runtime.InteropServices.NativeMethods.SendInput" />.
    /// </summary>
    internal class WindowsInputMessageDispatcher : IInputMessageDispatcher
    {
        ...
        ///     to <see cref="System.Runtime.InteropServices.NativeMethods.SendInput" />.
        /// </summary>
        ...
        {
            var successful = NativeInputs.SendInput((uint) inputs.Length, inputs, Marshal.SizeOf(typeof(Input)));
