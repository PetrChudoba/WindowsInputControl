...
namespace WindowsInputLogger
{
    ...
    class MacroVm
    {
        private readonly KeyboardMacroControl _macroControl;

        private RelayCommand _startRecord;

        public MacroVm(KeyboardMacroControl macroControl)
        {
            _macroControl = macroControl;

            _startRecord = new RelayCommand(startRecording);
        ...
        public ICommand ReplayStep { get;  }
